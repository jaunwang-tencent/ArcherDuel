...
local UIConfig = {
                ...
                Views = {
                    [1] = {
                        ...
                        GoodSlot = {
                            ID = 111319,
                            --装备槽
                            EquipmentSlots = { 111318, 111317, 111316, 111315, 111314, 111313 }
                        }
                    },
                    [2] = {
                        --商铺槽
                    ...
                    [3] = {
                        ...
                        GoodSlot = {
                            ID = 111305,
                            --装备槽
                            EquipmentSlots = { 111298, 111300, 111301, 111303, 111304, 111302}
                        }
                    },
                    [4] = {
                        --商铺槽
    ...
    SignIn = {
        ID = 118975,
        ButtonTable = 119009, -- 签到按钮组
        IAAButton = 119003, --双倍按钮
        Button = 119004, -- 直接领取按钮
        Text = 119025, -- 当日已签到文本
        --退出按钮
        Exit = 119026,
        Day= {
